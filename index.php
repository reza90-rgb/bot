...
$botToken =  "1926644733:AAHPMxR6Z7Si4LZgnzu4gU7liC2eRELYa9c";
...
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot1926644733:AAHPMxR6Z7Si4LZgnzu4gU7liC2eRELYa9c/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
file_get_contents("https://api.telegram.org/bot1926644733:AAHPMxR6Z7Si4LZgnzu4gU7liC2eRELYa9c/editMessageText?chat_id=$cchatid2&text=$finalize&message_id=$cmessage_id2&parse_mode=HTML");
}
...
// if(!in_array($chatId, $premiumgp)){
	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot1926644733:AAHPMxR6Z7Si4LZgnzu4gU7liC2eRELYa9c/getChatMember?chat_id=@roldexverse&user_id=".$gId))->result->status;
...
// exit();
// }
        	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot1926644733:AAHPMxR6Z7Si4LZgnzu4gU7liC2eRELYa9c/getChatMember?chat_id=@roldexversechats&user_id=".$gId))->result->status;
// if($tch != 'member' && $tch != 'creator' && $tch != 'administrator'){
// bot('sendMessage',['chat_id'=>$chatId,'reply_to_message_id'=>$message_id,'text'=>"Sorry <a href='tg://user?id=$gId'>$firstname</a>
// 
// You Need To Join My Update Channel To Get Regular Updates
...
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot1926644733:AAHPMxR6Z7Si4LZgnzu4gU7liC2eRELYa9c/".$method;
    $ch = curl_init();
