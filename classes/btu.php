...
curl_setopt($ch, CURLOPT_POSTFIELDS, '{"nonce":"'.$token.'","amount":"41.47","OrderID":"63881139","machine_name":"printerpixus14","customer_guid":"7074355e-13a5-4ccc-90f2-1485d29703ee","customer_ip":"153.92.0.18","payload_type":"NEWCARD","deviceData":"{\"device_session_id\":\"e0f65975d406cd417dfd87a5fae0f65f\",\"fraud_merchant_id\":null,\"correlation_id\":\"60fe05baae721ce4608922613c559aea\"}"}');
 $curl1 = curl_exec($ch);
 $result = curl_exec($ch);
